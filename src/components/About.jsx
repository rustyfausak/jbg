...
export default function About() {
  return (
    <StandardLayout>
      <div className="bg-stone-800 mt-20 px-6 lg:px-10">
        <h2 className="text-4xl font-serif sm:text-6xl mb-3">
          Meet Jess
        </h2>
        <p className="text-lg italic leading-8 text-stone-400">
      ...
      <div className="mx-auto py-24 sm:py-32 max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-20 lg:max-w-none lg:grid-cols-2">
          {/* Photo Section */}
          <div className="relative lg:order-last">
            <div className="aspect-[3/2] overflow-hidden rounded-2xl bg-stone-100">
